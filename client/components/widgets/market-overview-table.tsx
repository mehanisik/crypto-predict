...
import type { MarketData } from "@/lib/crypto";
...
import { useWidgetExpanded } from "../ui/widget";

export function MarketOverviewTable({ data }: { data: MarketData[] }) {
	const isExpanded = useWidgetExpanded();

	return (
		<div
			className={`${isExpanded ? "h-full" : "max-h-[35vh]"} flex flex-col overflow-hidden`}
		>
