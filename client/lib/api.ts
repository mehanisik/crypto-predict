...
export class ApiService {
  ...
  static async getPrediction(data: PredictionRequest): Promise<PredictionResponse> {
  ...
  static async cancelTraining(sessionId: string): Promise<{ success: boolean; message: string }> {
    const response = await server.post(API_ENDPOINTS.TRAINING_CANCEL(sessionId));
    return response.data;
  }
