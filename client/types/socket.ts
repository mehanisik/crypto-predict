...
export interface TrainingUpdateEvent extends BaseSocketEvent {
  ...
  rmse?: number;
  mape?: number;
  data?: TrainingProgressData | TrainingCompletionData | Record<string, unknown>;
...
export interface PredictionUpdateEvent extends BaseSocketEvent {
  type: 'prediction_started' | 'prediction_progress' | 'prediction_completed' | 'prediction_failed';
  progress?: number;
